...
Výhoda zaregistrování služby v systému spočívá v jednoduchém ovládání služby pomocí příkazu \verb|svcadm|. Tímto příkazem službu jednoduše dokážeme zapnout, vypnout nebo restartovat.
